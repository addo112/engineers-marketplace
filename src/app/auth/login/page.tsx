      ...
      <div className="hidden lg:flex w-1/2 bg-[#1e3a5f] text-white p-12 flex-col justify-between">
        <div>
          ...
          <h1 className="text-4xl font-bold leading-tight mt-20">
            The marketplace for professional engineers in Ghana.
          </h1>
          <p className="text-slate-300 mt-6 text-lg max-w-md">
            Connect with top engineering talent or find your next big project. Join our growing community today.
          </p>
        </div>
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="#" className="text-sm font-medium text-[#1e3a5f] hover:text-blue-800">
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#1e3a5f] text-white rounded-lg px-4 py-3 font-medium hover:bg-[#152a46] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1e3a5f]"
            >
              Log In
            </button>
          </form>
          ...
          <div className="mt-8">
            ...
            <button
              type="button"
              className="mt-6 w-full flex items-center justify-center gap-3 rounded-lg border border-slate-300 bg-white px-4 py-3 text-slate-700 font-medium hover:bg-slate-50 transition-colors"
            >
          ...
          <p className="mt-8 text-center text-sm text-slate-600">
            ...
            <Link href="/auth/register" className="font-medium text-[#1e3a5f] hover:text-blue-800">
              Register
            </Link>
          </p>
        </div>
